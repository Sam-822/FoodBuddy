...
function App() {
	...
	return (
		<>
			...
			<a type="button" className="btn btn-light" href='https://github.com/Sam-822/FoodBuddy' target='_blank' style={{ position: 'fixed', bottom: '10px', right: '10px' }}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
